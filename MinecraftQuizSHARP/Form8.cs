...
namespace MinecraftQuizSHARP
{
    public partial class Form8 : Form
    {
        ...
        private void btn_rept_Click(object sender, EventArgs e)
        {
            if (sele == 1)
            {
                picbox_challe.BackgroundImage = Properties.Resources.reds1_rept;
        ...
        private void btn_pedra_Click(object sender, EventArgs e)
        {
            if (sele == 1)
            {
                picbox_challe.BackgroundImage = Properties.Resources.reds1_pedra;
                btn_select.Visible = false;
                Timer2.Enabled = true;
                timer_crono.Enabled = false;
                sele = 0;
        ...
        private void btn_redstone_Click(object sender, EventArgs e)
        {
            if (sele == 1)
            {
                picbox_challe.BackgroundImage = Properties.Resources.reds1_reds;
                btn_select.Visible = false;
                Timer2.Enabled = true;
                timer_crono.Enabled = false;
                sele = 0;
