...
namespace MinecraftQuizSHARP
{
    public partial class Form5 : Form
    {
        ...
        private void btn_ok_Click(object sender, EventArgs e)
        {
            ...
            if (objeto == 3 && ordem == 3)
            {
                if (picbox_objeto2.Left == 293 && (picbox_objeto3.Top == 92 && (picbox_objeto3.Left == 293)))
                {
                ...
                else if (picbox_objeto2.Left == 435 && (picbox_objeto3.Top == 92 && (picbox_objeto3.Left == 435)))
                {
                    Module1.pontos_craft = Module1.pontos_craft + 1;
                    this.Hide();
                    Form f = new Form6();
                ...
                else if (picbox_objeto2.Left == 577 && (picbox_objeto3.Top == 92 && (picbox_objeto3.Left == 577)))
                {
                    Module1.pontos_craft = Module1.pontos_craft + 1;
                    this.Hide();
                    Form f = new Form6();
